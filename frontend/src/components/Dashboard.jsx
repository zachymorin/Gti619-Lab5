...
function Dashboard({ user }) {
    ...
    const handleSearchBusiness = async (e) => {
        ...
        try {
            ...
            const data = await searchBusinessCustomers(searchQuery)
            setSearchResults(data)
        } catch (err) {
            setError(err.message)
            setSearchResults([])
                    ...
                    case 'security-config':
                        return (
                            <div style={{ maxWidth: '450px' }}>
                                ...
                                >
                                    Ajustez les configurations de sécurité du
                                    système.
                                </p>
                                    ...
                                    >
                                        ...
                                        <div>
                                            ...
                                            <input
                                                ...
                                                max="10"
                                                value={
                                                    securityConfig.password_history_limit
                                                }
                                                onChange={(e) =>
                                                    setSecurityConfig({
                                                        ...securityConfig,
                                            ...
                                            >
                                                Nombre de mots de passe uniques
                                                avant réutilisation.
                                            </small>
                                        </div>
                        ...
                        return (
                            <div>
                                ...
                                >
                                    ...
                                    <button
                                        onClick={() =>
                                            setCurrentSubView('security-config')
                                        }
                                        style={actionButtonStyle}
                                    >
                ...
                return (
                    <div>
                        ...
                        <p style={{ color: '#6c757d' }}>
                            Rechercher et gérer les profils des particuliers.
                        </p>
                        ...
                        {!loading &&
                            ...
                            !error && (
                                ...
                                >
                                    Aucun client résidentiel trouvé pour{' '}
                                    {searchQuery}.
                                </p>
                            )}
                    </div>
            ...
            case "Préposé aux clients d'affaires":
                return (
                    <div>
                        ...
                        <p style={{ color: '#6c757d' }}>
                            Gestion du portefeuille des entreprises et comptes
                            commerciaux.
                        </p>
                        ...
                        {loading && (
                            <p style={{ color: '#007bff' }}>
                                Recherche commerciale en cours...
                            </p>
                        )}
                        ...
                        {!loading && searchResults.length > 0 && (
                            <div style={{ marginTop: '20px' }}>
                                <h4>
                                    Entreprises trouvées ({searchResults.length}
                                    ) :
                                </h4>
                                <ul
                                    style={{
...
const roleBadgeStyle = (role) => ({
    ...
    fontSize: '12px',
    fontWeight: 'bold',
    backgroundColor: role === 'Administrateur' ? '#e8f7ff' : '#e6fcf5',
    color: role === 'Administrateur' ? '#007bff' : '#0ca678',
    border:
        role === 'Administrateur' ? '1px solid #bbeeec' : '1px solid #c3fae8',
})
