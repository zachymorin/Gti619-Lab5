...
export function SecurityConfigForm({ securityConfig, setSecurityConfig, onSubmit, loading, error, onBack }) {
    return (
        <div style={{ maxWidth: '450px' }}>
            ...
            {loading ? (
                ...
                <form onSubmit={onSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '20px', marginTop: '15px' }}>
                    <div>
